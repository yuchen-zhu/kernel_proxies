...
parser.add_argument('--sem', default='std', type=str)
parser.add_argument('--discrete', default=False, type=bool, help='indicate discrete actions')
...
def process_kpv(do_A, args):
    ...
    for train_sz in train_sizes:
        ...
        kpv_change_abs = (kpv_change_abs_over_seeds_av_each_a, kpv_change_abs_over_seeds_av, kpv_change_abs_over_seeds_std, kpv_change_abs_over_seeds)
        ...
        kpv_deriv_abs = (kpv_deriv_abs_over_seeds_av_each_a, kpv_deriv_abs_over_seeds_av, kpv_deriv_abs_over_seeds_std, kpv_deriv_abs_over_seeds)
        ...
        kpv_change_rel = (kpv_change_rel_over_seeds_av_each_a, kpv_change_rel_over_seeds_av, kpv_change_rel_over_seeds_std, kpv_change_rel_over_seeds)
        ...
        kpv_deriv_rel = (kpv_deriv_rel_over_seeds_av_each_a, kpv_deriv_rel_over_seeds_av, kpv_deriv_rel_over_seeds_std, kpv_deriv_rel_over_seeds)
        ...
        kpv_collect[train_sz] = (kpv_abs, kpv_change_abs, kpv_deriv_abs, kpv_rel, kpv_change_rel, kpv_deriv_rel, kpv_res_)
        print(kpv_collect)
    return kpv_collect
...
def process_mmr(do_A, args):
    ...
    for train_sz in train_sizes:
        ...
        for seed in args.seeds:
            ...
            mmr_res = (np.load(os.path.join(PATH, args.date, args.sem+'_seed{}'.format(seed),
                                               'mmr_res_trainsz{}_offset{}.npz'.format(train_sz, args.offset_bool)))['ate_est']).squeeze()
        ...
        mmr_change_abs = (mmr_change_abs_over_seeds_av_each_a, mmr_change_abs_over_seeds_av, mmr_change_abs_over_seeds_std, mmr_change_abs_over_seeds)
        ...
        mmr_deriv_abs = (mmr_deriv_abs_over_seeds_av_each_a, mmr_deriv_abs_over_seeds_av, mmr_deriv_abs_over_seeds_std, mmr_deriv_abs_over_seeds)
        ...
        mmr_change_rel = (mmr_change_rel_over_seeds_av_each_a, mmr_change_rel_over_seeds_av, mmr_change_rel_over_seeds_std, mmr_change_rel_over_seeds)
        ...
        mmr_deriv_rel = (mmr_deriv_rel_over_seeds_av_each_a, mmr_deriv_rel_over_seeds_av, mmr_deriv_rel_over_seeds_std, mmr_deriv_rel_over_seeds)
        ...
        mmr_collect[train_sz] = (mmr_abs, mmr_change_abs, mmr_deriv_abs, mmr_rel, mmr_change_rel, mmr_deriv_rel, mmr_res_)
...
def process_blines(do_A, args):
    ...
    keys = pickle.load(open(os.path.join(PATH, args.date, args.sem + '_seed{}'.format(seeds[0]),
                           'results_baselines_trainsz{}_seed527_reps1.p'.format(train_sizes[0])), 'rb')).keys()
    ...
    for train_sz in train_sizes:
        ...
        for bline in keys:
            ...
            for seed in args.seeds:
                ...
                # get baselines estimates
                with open(os.path.join(PATH, args.date, args.sem+'_seed{}'.format(seed), 'results_baselines_trainsz{}_seed527_reps1.p'.format(train_sz)), 'rb') as bline_handle:
        ...
        for bline in blines:
            ...
            bline_abs = (bline_abs_over_seeds_av_each_a, bline_abs_over_seeds_av, bline_abs_over_seeds_std, bline_abs_over_seeds)
            ...
            bline_change_abs = (bline_change_abs_over_seeds_av_each_a, bline_change_abs_over_seeds_av, bline_change_abs_over_seeds_std, bline_change_abs_over_seeds)
            ...
            bline_deriv_abs = (bline_deriv_abs_over_seeds_av_each_a, bline_deriv_abs_over_seeds_av, bline_deriv_abs_over_seeds_std, bline_deriv_abs_over_seeds)
            ...
            bline_rel = (bline_rel_over_seeds_av_each_a, bline_rel_over_seeds_av, bline_rel_over_seeds_std, bline_rel_over_seeds)
            ...
            bline_change_rel = (bline_change_rel_over_seeds_av_each_a, bline_change_rel_over_seeds_av, bline_change_rel_over_seeds_std, bline_change_rel_over_seeds)
            ...
            bline_deriv_rel = (bline_deriv_rel_over_seeds_av_each_a, bline_deriv_rel_over_seeds_av, bline_deriv_rel_over_seeds_std, bline_deriv_rel_over_seeds)
            ...
            blines_collect[train_sz][bline] = (bline_abs, bline_change_abs, bline_deriv_abs, bline_rel, bline_change_rel, bline_deriv_rel, bline_res_)
...
def plot_curves_w_intevals(save_name, X, x_name, y_name, legend_loc, legend_name, y_lim, args, trainsize, **curves_dict):
    ...
    for method in curves_dict.keys():
        ...
        if method == r'$\bf{KPV}$':
            ...
            if args.discrete:
                ...
                ax.plot(X, y_mean, 'x', color=colours[colour_counter], label='groundtruth', alpha=0.8, linewidth=2, zorder=10)
                colour_counter += 1
        else:
            print(method)
...
def _plot_curves_w_intevals(save_name, X, x_name, y_name, legend_loc, legend_name, y_lim, args, trainsize, **curves_dict):
    BIGGER_SIZE=14
    sns.set_style("whitegrid")
    plt.clf()
    plt.rc('font', size=BIGGER_SIZE)
    ...
    for train_sz in train_sizes:
        if not args.discrete:
            ...
            plot_curves_w_intevals(save_name='do_A_plot_{}_all_m_trainsz{}'.format(args.sem, train_sz), X=do_A,
                                   x_name='A', y_name='E[Y|do(A)]', legend_loc=3, legend_name='legend_do_A_{}'.format(args.sem), y_lim=[-1., 1.5], trainsize=train_sz, args=args, **do_A_to_plot)
            plot_curves_w_intevals(save_name='abs_over_A_plot_{}_all_m_trainsz{}'.format(args.sem, train_sz), X=do_A,
                                   x_name='A', y_name='E[Y|do(A)] - E_wh(A,W)', legend_loc=3, legend_name='legend_abs_over_A_{}'.format(args.sem), y_lim=[0., 2.], trainsize=train_sz, args=args, **abs_over_A_to_plot)
            ...
            make_boxplots(save_name='do_A_boxplot_{}_all_m_trainsz{}'.format(args.sem, train_sz), legend_loc=3, df=bp_df, args=args)

        write_latex(kpv_collect_sz=kpv_collect[train_sz], mmr_collect_sz=mmr_collect[train_sz], blines_collect_sz=blines_collect[train_sz],
                    train_sz=train_sz)
