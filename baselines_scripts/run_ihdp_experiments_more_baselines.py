import torch
import numpy as np
from baselines_scripts.baselines.all_baselines import Vanilla2SLS, DeepIV, Bases2SLS, KRidge
import os
import tensorflow
# from tabulate import tabulate
from PMMR.util import ROOT_PATH, load_data, data_transform, visualise_ATEs
# random.seed(527)
import argparse
...
if __name__ == "__main__":
    ...
    sname, train_sizes = 'sim_1d_no_x', [1000]
