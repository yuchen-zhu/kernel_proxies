...
def precomp(sname,i,seed=527):
    ...
    folder = ROOT_PATH+'/kpv_rbfNonLinearYFullTrain10000scaledSig2NewTest/'
    ...
    for sname in ['mnist_z','mnist_x','mnist_xz']:
        if sname in ['mnist_z','mnist_xz']:
            ...
            for w_id in range(400):
                res = np.load(ROOT_PATH+'/kpv_rbfNonLinearYFullTrain10000scaledSig2NewTest/{}_K_{}.npz'.format(sname,w_id))
                os.remove(ROOT_PATH+'/kpv_rbfNonLinearYFullTrain10000scaledSig2NewTest/{}_K_{}.npz'.format(sname,w_id))
        ...
        if sname in ['mnist_x','mnist_xz']:
            ...
            test_L0 = []
            for i in range(8):
                L0 = np.load(ROOT_PATH+'/kpv_rbfNonLinearYFullTrain10000scaledSig2NewTest/{}_L_{}.npz'.format(sname,i))
                os.remove(ROOT_PATH + '/kpv_rbfNonLinearYFullTrain10000scaledSig2NewTest/{}_L_{}.npz'.format(sname,i))
